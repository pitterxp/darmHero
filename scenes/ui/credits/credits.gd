...
var intro_sequence = [
	...
	{"node": "text6", "fade_in_duration": 0.75, "display_duration": 5, "fade_out_duration": 0.75}
]
...
func _ready():
	...
	text6.modulate.a = 0.0
	
	AudioManager.play_bgm("Divertissement")
	
	# TODO brauchen wir das hier?
	# Wurden die Credits bereits aufgerufen?
	"""
